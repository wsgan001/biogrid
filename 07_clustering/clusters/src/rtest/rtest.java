...
public class rtest {
    ...
    public static void main(String[] args) {
        ...
        //System.loadLibrary only accepts a filename and looks for the file 
        //in the current java paths available. You'll want to add the 
        //directory containing FasExtend.dll to your java path, 
        //then just use System.loadLibrary("FasExtend")
        // I made a soft link:
        //sudo ln -s /Library/Frameworks/R.framework/Resources/library/rJava/jri/libjri.jnilib /usr/lib/java
        System.loadLibrary("jri");
        // after that it was whining that I need to set the environmental vriable for R_HOME
        // there were two problems with that - whicch chelll is Netbeans startd from,
        // and what should be the R_HOME
        // after some googling, it turns out that R_HOME is /Library/Frameworks/R.framework/Versions/Current/Resources
        // and it can be set by adding a line
        //export R_HOME="/Library/Frameworks/R.framework/Versions/Current/Resources"
        // to the netbeans.conf file in 
	...
	// 1) we pass the arguments from the command line
        ...
        Rengine re = new Rengine(args2, false, new TextConsole());
